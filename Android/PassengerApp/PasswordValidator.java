...
public class PasswordValidator {
    ...
    public static class PasswordStrength {
        public StrengthLevel strengthLevel = StrengthLevel.WEAK;//default weak
        public String errorMessage = "";
    }

    public static PasswordStrength checkPasswordStrength(String password) {//password from signup
        ...
        if (password.matches(".*[a-z].*")) strengthScore++;
        if (password.matches(".*\\d.*")) strengthScore++;//contain integer
